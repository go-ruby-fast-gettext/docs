...
The public API lives at the module root (`github.com/go-ruby-fast-gettext/fast-gettext`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `fast-gettext`, while the surface follows
...
```go
import "github.com/go-ruby-fast-gettext/fast-gettext"
```
...
- **[pkg.go.dev/github.com/go-ruby-fast-gettext/fast-gettext](https://pkg.go.dev/github.com/go-ruby-fast-gettext/fast-gettext)**

The module's [README](https://github.com/go-ruby-fast-gettext/fast-gettext#readme) carries worked
