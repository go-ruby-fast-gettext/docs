...
Contributions are welcome. `go-ruby-fast-gettext/fast-gettext` is built to a small set of
...
The library is in [`github.com/go-ruby-fast-gettext/fast-gettext`](https://github.com/go-ruby-fast-gettext/fast-gettext).
This documentation site is in [`github.com/go-ruby-fast-gettext/docs`](https://github.com/go-ruby-fast-gettext/docs).
